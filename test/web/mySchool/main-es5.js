(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("<div>\n  <a routerLink=\"/addTeacher\"><button > 添加教师</button></a>\n</div>\n<table class=\"tablelist\">\n  <tr><th>序号</th><th>教师姓名</th><th>职称</th><th>最高学位</th><th>所属专业</th><th>操作</th></tr>\n  <tr *ngFor=\"let teacher of teachers\" class=\"badge\">\n    <td><a routerLink=\"/detailTeacher/{{teacher.id}}\" [queryParams]=\"teacher\">{{teacher.id}}</a></td>\n    <td><a routerLink=\"/detailTeacher/{{teacher.id}}\" [queryParams]=\"teacher\">{{teacher.name}}</a></td>\n    <td *ngIf=\"teacher.profTitle\"><a routerLink=\"/detailTeacher/{{teacher.id}}\" [queryParams]=\"teacher\">{{teacher.profTitle.description}}</a></td>\n    <td *ngIf=\"teacher.degree\"><a routerLink=\"/detailTeacher/{{teacher.id}}\" [queryParams]=\"teacher\">{{teacher.degree.description}}</a></td>\n    <td *ngIf=\"teacher.department\"><a routerLink=\"/detailTeacher/{{teacher.id}}\" [queryParams]=\"teacher\">{{teacher.department.description}}</a></td>\n    <td><a routerLink=\"/updateTeacher/{{teacher.id}}\"><button class=\"update\" >修改</button></a><button class=\"delete\"  (click)=\"delete(teacher)\">删除</button></td>\n  </tr>\n</table>\n");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("<div>\n  <a routerLink=\"/addTitle\"><button > 添加职称</button></a>\n</div>\n<table class=\"tablelist\">\n  <tr><th>序号</th><th>编号</th><th>职称名称</th><th>备注</th><th>操作</th></tr>\n  <tr *ngFor=\"let title of titles\" class=\"badge\">\n    <td><a routerLink=\"/detailTitle/{{title.id}}\" [queryParams]=\"title\">{{title.id}}</a></td>\n    <td><a routerLink=\"/detailTitle/{{title.id}}\" [queryParams]=\"title\">{{title.no}}</a></td>\n    <td><a routerLink=\"/detailTitle/{{title.id}}\" [queryParams]=\"title\">{{title.description}}</a></td>\n    <td><a routerLink=\"/detailTitle/{{title.id}}\" [queryParams]=\"title\">{{title.remarks}}</a></td>\n    <td><a routerLink=\"/updateTitle/{{title.id}}\"><button class=\"update\" >修改</button></a><button class=\"delete\"  (click)=\"delete(title)\">删除</button></td>\n  </tr>\n</table>\n");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddDegreeComponent = /** @class */ (function () {
                ...
                AddDegreeComponent.prototype.save = function (no, description, remarks) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddDepartmentComponent = /** @class */ (function () {
                ...
                AddDepartmentComponent.prototype.getSchools = function () {
                    var _this = this;
                    this.departmentService.getSchools()
                        .subscribe(function (res) { return _this.schools = res; });
                };
                AddDepartmentComponent.prototype.save = function (description, no, school, remarks) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UpdateDepartmentComponent = /** @class */ (function () {
                ...
                UpdateDepartmentComponent.prototype.compareFn = function (o1, o2) {
                    return o1 && o2 ? o1.id === o2.id : o1 === o2;
                };
                UpdateDepartmentComponent.prototype.getSchools = function () {
                    var _this = this;
                    this.departmentService.getSchools()
                        .subscribe(function (res) { return _this.schools = res; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EntityService = /** @class */ (function () {
                ...
                EntityService.prototype.getSchools = function () {
                ...
                EntityService.prototype.getSchool = function (id) {
                ...
                EntityService.prototype.addSchool = function (school) {
                ...
                EntityService.prototype.deleteSchool = function (school) {
                ...
                EntityService.prototype.updateSchool = function (school) {
                ...
                EntityService.prototype.getDegrees = function () {
                ...
                EntityService.prototype.getDegree = function (id) {
                ...
                /** POST: add a new college to the server */
                EntityService.prototype.addDegree = function (degree) {
                ...
                /** DELETE: delete the college from the server */
                EntityService.prototype.deleteDegree = function (degree) {
                ...
                /** PUT: update the hero on the server */
                EntityService.prototype.updateDegree = function (degree) {
                ...
                EntityService.prototype.getDepartments = function () {
                ...
                EntityService.prototype.getDepartment = function (id) {
                ...
                EntityService.prototype.addDepartment = function (department) {
                ...
                EntityService.prototype.deleteDepartment = function (department) {
                ...
                /** PUT: update the hero on the server */
                EntityService.prototype.updateDepartment = function (department) {
                ...
                EntityService.prototype.getTitles = function () {
                ...
                EntityService.prototype.getTitle = function (id) {
                ...
                EntityService.prototype.addTitle = function (title) {
                ...
                EntityService.prototype.deleteTitle = function (title) {
                ...
                /** PUT: update the hero on the server */
                EntityService.prototype.updateTitle = function (title) {
                ...
                EntityService.prototype.getTeachers = function () {
                ...
                EntityService.prototype.getTeacher = function (id) {
                ...
                EntityService.prototype.addTeacher = function (teacher) {
                ...
                EntityService.prototype.deleteTeacher = function (teacher) {
                ...
                /** PUT: update the hero on the server */
                EntityService.prototype.updateTeacher = function (teacher) {
                ...
                EntityService.prototype.getDepSch = function (id) {
                    var url = this.departmentUrl + '?paraType=school&id=' + id;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddTeacherComponent = /** @class */ (function () {
                ...
                AddTeacherComponent.prototype.save = function (name, title, degree, department) {
                    var _this = this;
                    this.teacher = { name: name.trim(), title: this.title, degree: this.degree, department: this.department };
                    if (!name) {
                        return;
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddTitleComponent = /** @class */ (function () {
                ...
                AddTitleComponent.prototype.save = function (no, description, remarks) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
            /* harmony import */ var _entity_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../entity.service */ "./src/app/entity.service.ts");
            var DetaillTitleComponent = /** @class */ (function () {
                function DetaillTitleComponent(route, titleService, location) {
                    this.route = route;
                    this.titleService = titleService;
                    this.location = location;
                }
                DetaillTitleComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.queryParams
                        .subscribe(function (params) {
                        _this.title = params;
                ...
                DetaillTitleComponent.prototype.goBack = function () {
                    this.location.back();
                };
                return DetaillTitleComponent;
            }());
            DetaillTitleComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
                { type: _entity_service__WEBPACK_IMPORTED_MODULE_4__["EntityService"] },
                { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"] }
            ]; };
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! E:\web\myschool\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
