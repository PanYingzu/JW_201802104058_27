...
public class DepartmentController extends HttpServlet {
    //请使用以下JSON测试增加功能
    //{"description":"土管","no":"02","remarks":"","school_id":1}
    //请使用以下JSON测试修改功能
    //{"description":"房管","id":1,"no":"01","remarks":"","school":{"id":1}}

    /**
     * POST, http://49.235.2.175:8080/bysj/department.ctl, 增加专业
    ...
    /**
     * DELETE, http://49.235.2.175:8080/bysj/department.ctl?id=1, 删除id=1的专业
    ...
    /**
     * PUT, http://49.235.2.175:8080/bysj/department.ctl, 修改专业
     *
    ...
    /**
     * GET, http://49.235.2.175:8080/bysj/department.ctl?id=1, 查询id=1的专业
     * GET, http://49.235.2.175:8080/bysj/department.ctl, 查询所有的专业
     * 把一个或所有专业对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
